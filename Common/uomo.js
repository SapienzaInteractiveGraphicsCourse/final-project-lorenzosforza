...
function spallaDestraFunc(){
    corpo[spallaDestraId].mesh.rotation.x = corpo[torsoId].mesh.rotation.x
...
function bicipiteDestroFunc(){
    corpo[bicipiteDestroId].mesh.rotation.x = corpo[torsoId].mesh.rotation.x
    xRel = 0.0
    yRel = -0.15
    zRel =  0.0
...
function avambraccioDestroFunc(){
    corpo[avambraccioDestroId].mesh.rotation.x = corpo[torsoId].mesh.rotation.x
    xRel = 0.0
    yRel = -0.25
    zRel =  0.0

    corpo[avambraccioDestroId].mesh.position.x = corpo[bicipiteDestroId].mesh.position.x + xRel
    corpo[avambraccioDestroId].mesh.position.y = corpo[bicipiteDestroId].mesh.position.y+yRel*Math.cos(corpo[torsoId].mesh.rotation.x)-zRel*Math.sin(corpo[torsoId].mesh.rotation.x)//corpo[torsoId].mesh.position.y-corpo[torsoId].mesh.geometry.parameters.height/2 - 0.30/2*(1.0-Math.sin(rotMatrix[pantaloncinoDestroId][0]))
    corpo[avambraccioDestroId].mesh.position.z = corpo[bicipiteDestroId].mesh.position.z+yRel*Math.sin(corpo[torsoId].mesh.rotation.x)+zRel*Math.cos(corpo[torsoId].mesh.rotation.x)
    

}

function spallaSinistraFunc(){
    corpo[spallaSinistraId].mesh.position.z = corpo[torsoId].mesh.position.z
    corpo[spallaSinistraId].mesh.position.y = corpo[torsoId].mesh.position.y + corpo[torsoId].mesh.geometry.parameters.height/2-0.05
    corpo[spallaSinistraId].mesh.position.x = corpo[torsoId].mesh.position.x - corpo[torsoId].mesh.geometry.parameters.width/2-0.05
}

function bicipiteSinistroFunc(){
    corpo[bicipiteSinistroId].mesh.position.z = corpo[spallaSinistraId].mesh.position.z
    corpo[bicipiteSinistroId].mesh.position.y = corpo[spallaSinistraId].mesh.position.y-0.15
    corpo[bicipiteSinistroId].mesh.position.x = corpo[spallaSinistraId].mesh.position.x
}

function avambraccioSinistroFunc(){
    corpo[avambraccioSinistroId].mesh.position.z = corpo[bicipiteSinistroId].mesh.position.z
    corpo[avambraccioSinistroId].mesh.position.y = corpo[bicipiteSinistroId].mesh.position.y-0.25
    corpo[avambraccioSinistroId].mesh.position.x = corpo[bicipiteSinistroId].mesh.position.x
}
