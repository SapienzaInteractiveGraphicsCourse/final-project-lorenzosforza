...
moviment.push([-Math.PI/6,0.0,0.0,-Math.PI/4,0.0,Math.PI/4,Math.PI/4,0.0,Math.PI/4,Math.PI/2,0.0,-Math.PI/4,0.0,-Math.PI/8,0.0,-Math.PI/6,0.0])
moviment.push([-Math.PI/6,0.0,0.0,Math.PI/4,0.0,Math.PI/4,-Math.PI/4,0.0,Math.PI/4,Math.PI/6,0.0,-Math.PI/6,0.0,Math.PI/2,0.0,-Math.PI/4,0.0])
moviment.push([-Math.PI/6,0.0,0.0,-Math.PI/4,0.0,Math.PI/4,Math.PI/4,0.0,Math.PI/4,Math.PI/2,0.0,-Math.PI/4,0.0,-Math.PI/8,0.0,-Math.PI/6,0.0])
moviment.push([-Math.PI/6,0.0,0.0,Math.PI/4,0.0,Math.PI/4,-Math.PI/4,0.0,Math.PI/4,Math.PI/6,0.0,-Math.PI/6,0.0,Math.PI/2,0.0,-Math.PI/4,0.0])
